...
NapiCli.prototype['do_list-networks'].help = 'List networks';
...
NapiCli.prototype['do_get-network'] = function (subcmd, opts, args, callback) {
    ...
    this.napiAction({ fn: 'getNetwork', fnArgs: [ uuid ] }, callback);
};

NapiCli.prototype['do_get-network'].help = 'Get a network';
...
NapiCli.prototype['do_create-network'].help = 'Create a network';
...
NapiCli.prototype['do_update-network'].help = 'Update a network';
...
NapiCli.prototype['do_delete-network'] =
    ...
    this.napiAction({ fn: 'deleteNetwork', fnArgs: [ uuid ] }, callback);
};

NapiCli.prototype['do_delete-network'].help = 'Delete a network';
