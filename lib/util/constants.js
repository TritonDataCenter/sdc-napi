...
var MESSAGES = {
    ...
    VLAN_ON_VPC: 'VPC must not have any networks in use',
    VLAN_USED: 'VLAN ID is already in use',
    VNET: 'VNET ID must be a number between 0 and 16777215',
    VPC_FABRIC_NETWORK: 'Network cannot be both a fabric and VPC network',
    VPC_PROP_IMMUTABLE: 'Network updates for this field are not supported on ' +
    'VPCs',
    VPC_UUID_MISSING: 'VPC networks require a VPC UUID'
};
...
var FORMAT_MESSAGES = {
    ...
    VPC_SUBNET_INVALID: 'Subnet "%s" not contained within VPC CIDR block(s)',
    VPC_QUOTA_EXCEEDED: 'The number of VPCs in use (%d) exceeds account limit' +
    '%d'
};
