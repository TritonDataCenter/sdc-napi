...
function listNics(req, res, next) {
  mod_nic.list(req.app, req.log, req.params, function (err, nics) {
...
function getNic(req, res, next) {
  mod_nic.get(req.app, req.log, req.params, function (err, nic) {
...
function putNic(req, res, next) {
  mod_nic.update(req.app, req.log, req.params, function (err, nic) {
...
function deleteNic(req, res, next) {
  mod_nic.del(req.app, req.log, req.params, function (err) {
...
function register(http, before) {
  ...
  http.head({ path: '/nics/:mac', name: 'headNic' },
    before, getNic);
  http.put({ path: '/nics/:mac', name: 'putNic' },
      before, putNic);
